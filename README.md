...
| [CARAKURI — からくりの町](https://hfot.github.io/nomad-3d/town/) | Cardanoの仕組みを8体のからくりと一つの城郭都市に組み上げた3D。六つの門はリレー健全性の6軸、中央の書庫塔は憲法。**実測ではなく寓話**で、すべてブラウザ内で生成される |
...
og/             各ページの紹介画像（1200×630・日本語は各サイトのOGP画像、英語は <id>-en.png）
icons/          ページ下部ドックのアイコン（32×32）
```
...
スクリプトが動かない場合は日本語が表示される。紹介画像も言語に追従する。
